...
public class SmsActivity extends Activity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        passWord_et = (EditText) findViewById(R.id.cord);
        Message_btn = (Button) findViewById(R.id.getcord);
        login_btn = (Button) findViewById(R.id.savecord);
    }
    ...
    private void initBomb() {
        BmobSMS.initialize(SmsActivity.this, "64a9582a1950cfc5eac1b65afb3b11e2");
    ...
    public void onClick(View v) {
        ...
        Log.e("MESSAGE:", "1");
        String userName = phone_et.getText().toString();
